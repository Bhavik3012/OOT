...
class HotelService(Service):
    def get_info(self):
        return f"[Hotel] {self.service_name} | {self.origin} | Date: {self.date} | ₹{self.price}"

class HomestayService(Service):
    def get_info(self):
        return f"[Homestay] {self.service_name} | {self.origin} | Date: {self.date} | ₹{self.price}"

class FarmhouseService(Service):
    def get_info(self):
        return f"[Farmhouse] {self.service_name} | {self.origin} | Date: {self.date} | ₹{self.price}"
